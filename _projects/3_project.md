...
+----------------------------------------------------------------------------------------------------------------+
| HSDE IPM for Linear SOCP                                                                                       |
+================================================================================================================+
| **Input: Accuracy parameter**$\mathbf{\epsilon > 0}$**,**                                                      |
| $\left( x_{0},s_{0},y_{0},\ \tau_{0},\kappa_{0} \right) \in K \times K \times R^{m} \times R_{+} \times R_{+}$ |
|                                                                                                                |
| **Output:** $(x,s,y,\tau,\kappa),\ g,\ flag.\{ pfeas,dfeas,opt\}$                                              |
+----------------------------------------------------------------------------------------------------------------+
| 1.  **function HSDESolver**$\left( A,\ b,c,K,x_{0},s_{0},y_{0},\ \tau_{0},\kappa_{0} \right)$                  |
|                                                                                                                |
| 2.  $(x,s,y,\tau,\kappa)\mathbf{=}\left( x_{0},s_{0},y_{0},\ \tau_{0},\kappa_{0} \right)$                      |
|                                                                                                                |
| 3.  **while** ${g = x}^{T}s + \tau\kappa > \epsilon$ **do**                                                    |
|                                                                                                                |
| 4.  calculate Scaling $W,W^{- 1}$, construct $AW^{- 2}A^{T}$,                                                  |
|                                                                                                                |
| 5.  $LDL^{T} = AW^{- 2}A^{T}$, get Calculation **Flow** at first time                                          |
|                                                                                                                |
| 6.  Predictor: solve KKT with $v = 0,E_{xs} = 0,\ E_{\tau\kappa} = 0$, get                                     |
|     $\left( \Delta x_{p},\Delta s_{p},\Delta y_{p},\Delta\tau_{p},\Delta\kappa_{p} \right)$                    |
|                                                                                                                |
| 7.  calculate step $\alpha_{p}$                                                                                |
|                                                                                                                |
| 8.  update centering parameter $v$, and $E_{xs},\ E_{\tau\kappa}$                                              |
|                                                                                                                |
| 9.  Corrector: solve KKT with $v,E_{xs},\ E_{\tau\kappa}$, get                                                 |
|     $(\Delta x,\Delta s,\Delta y,\Delta\tau,\Delta\kappa)$                                                     |
|                                                                                                                |
| 10. calculate step $\alpha$                                                                                    |
|                                                                                                                |
| 11. calculate next iteration point:                                                                            |
|     $(x,s,y,\tau,\kappa) + \alpha(\Delta x,\Delta s,\Delta y,\Delta\tau,\Delta\kappa)$                         |
|                                                                                                                |
| 12. **end while**                                                                                              |
|                                                                                                                |
| 13. **switch**                                                                                                 |
|                                                                                                                |
| 14. **case 0:** $\tau > 0,\ \kappa = 0,and\ g > \epsilon$, $(x,s,y) = \lbrack x,s,y\rbrack./\tau$,             |
|     flag.feas=true, flag.opt=false;                                                                            |
|                                                                                                                |
| 15. **case 1:** $\tau > 0,\ \kappa = 0,and\ g < \epsilon$, $(x,s,y) = \lbrack x,s,y\rbrack./\tau$,             |
|     flag.feas=true, flag.opt=true;                                                                             |
|                                                                                                                |
| 16. **case 2:** $\kappa > 0,\ \tau = 0,\ and\ b^{T}y > 0$, flag.pfeas=false;                                   |
|                                                                                                                |
| 17. **case 3:** $\kappa > 0,\tau = 0,\ and\ c^{T}x < 0$, flag.dfeas=false;                                     |
|                                                                                                                |
| 18. **case 4:** $\tau = 0,\ \kappa = 0$ flag.feas=false;                                                       |
|                                                                                                                |
| 19. **end switch**                                                                                             |
|                                                                                                                |
| 20. **return** $(x,s,y,\tau,\kappa),\ g,\ flag.\{ pfeas,dfeas,opt\}$                                           |
|                                                                                                                |
| 21. **end function**                                                                                           |
+----------------------------------------------------------------------------------------------------------------+
|                                                                                                                |
...
可直观理解DRS中的操作，
  ...
  抽象算子                                                                                                算子 in QSOCP                                            解释
  ------------------------------------------------------------------------------- ------------------------------------------------------------- ------------------------------------------
  $$\mathbf{F}$$                                                                   $$F(z) = (Mz + q) \in \left\{ 0 \right\}^{n} \times K^{*}$$            原始可行和对偶可行条件

  $$\left( \mathbf{I}\mathbf{+}\mathbf{F} \right)^{\mathbf{- 1}}$$                          $$(I + M)^{- 1}\left( w^{k} - q \right)$$                      满足可行条件的初始解

  $$\mathbf{G}$$                                                                                       法锥算子 $N_{C}(z)$                                  锥约束(不等式条件)

  $$\left( \mathbf{I}\mathbf{+}\mathbf{N}_{\mathbf{C}} \right)^{\mathbf{- 1}}$$                          $$\Pi_{C}(x)$$                                 向凸锥投影，满足锥几何约束

  MIP                                                                                               $$0 \in F(z) + N_{C}(z)$$                                    KKT条件:
                                                                                                                                                 满足原始可行、对偶可行、锥约束、互补松弛

  DRS                                                                                     $$w^{*} = R_{G}(R_{F}\left( w^{*} \right))$$                交替执行两个反射，收敛到不动点
  ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
非负锥定义为${\ K}_{\leq 0},\ \{ x \in R_{n}|x \geq 0\}$，则整个向量$\ v\ $到非负锥$\ R_{+}^{n}\ $的投影$\ \Pi_{R_{+}^{n}}(v)\ $就是每个分量取正部，

$$\Pi_{R_{+}^{n}}\left( v_{i} \right) = \max\left( 0,v_{i} \right)$$

##### 1.B 二阶锥投影

SOC定义为$\ K_{2} = \ \left\{ (t,x) \in {R \times R}_{n} \right|\ |x|_{2} \leq t\}$，给定点$\ v = (t,x)\ $向$\ K_{2}\ $的投影需分情况讨论，
